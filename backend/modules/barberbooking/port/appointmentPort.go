...
type IAppointment interface {
	...
	CancelAppointment(ctx context.Context, appointmentID uint, actorUserID uint) error
	RescheduleAppointment( ctx context.Context,appointmentID uint,newStartTime time.Time,actorUserID uint,) error
